...
export const PRODUCT_MODULE_NAME = "proc_opt";
...
export const RelativeExePath = "\\SuperApp\\proc_opt\\proc_opt.exe";
export const RelativeDatPath = "\\SuperApp\\proc_opt\\proc_opt.dat";
// 配置文件路径（此处仅为示例，如果客户端有配置文件，也可以用）
export const RelativeConfigPath = "\\SuperApp\\proc_opt\\proc_opt.set";
